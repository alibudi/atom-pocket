<aside class="app-sidebar sidebar-scroll">
				<div class="main-sidebar-header active">
					<h2 style="color: white">Atom Dompet</h2>
				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item" href="chart-morris.html">Dompet</a></li>
								<li><a class="slide-item" href="chart-flot.html">Kategori</a></li>
							</ul>
						</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item" href="chart-morris.html">Dompet Masuk</a></li>
								<li><a class="slide-item" href="chart-flot.html">Dompet Keluar</a></li>
							</ul>
						</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item" href="chart-morris.html">Laporan Transaksi</a></li>
